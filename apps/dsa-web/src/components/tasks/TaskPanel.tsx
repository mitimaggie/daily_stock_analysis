...
const TaskItem: React.FC<TaskItemProps> = ({ task }) => {
  ...
  return (
    <div className="flex items-center gap-3 px-3 py-2 bg-elevated rounded-lg border border-black/[0.03]">
      {/* 状态图标 */}
...
export const TaskPanel: React.FC<TaskPanelProps> = ({
  ...
  return (
    <div className={`bg-surface rounded-xl border border-black/[0.03] overflow-hidden ${className}`}>
      {/* 标题栏 */}
