...
class SearchService:
    ...
    def search_comprehensive_intel(
        ...
        combined = (
            ...
            "1. 【核心风险与雷区】立案调查、监管函、高比例质押（质押率%）\n"
            "2. 【业绩与盈利预期】业绩预告、超预期/暴雷、最新机构盈利预测变化（EPS均值及变化方向）\n"
            "3. 【行业与竞争格局】行业政策红利/压力、竞争对手动态、机构密集调研\n"
            "4. 【资金博弈（重点）】请逐项列出：\n"
            "   a. 大股东/高管增减持：近3个月谁减持/增持了多少股（或金额），减持是否已完成？\n"
            "   b. 限售解禁：下次解禁时间、规模（亿元）、占流通股比例（%）\n"
            "   c. 股票回购：是否有回购计划？已回购多少金额/数量？剩余未执行规模？\n"
            "   d. 融资融券余额：近30日变化趋势（上升/下降），当前融资余额约多少亿？\n"
