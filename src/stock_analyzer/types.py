...
class BuySignal(Enum):
    ...
    阈值基于7353条回测+495条真实记录校准（2026-03）
    """
    AGGRESSIVE_BUY = "强信号做多"       # 95+: 共振信号+趋势确认，大胆上车
    STRONG_BUY = "信号偏强"       # 85-94: 多重指标共振，胜率高
    BUY = "买入"                # 78-84: 技术面看好，可建仓
    HOLD = "持有"                # 55-77: 中性，持股待涨（75-77分历史胜率21.4%，负期望，归并至持有）
    REDUCE = "减仓"              # 35-54: 信号转弱，逐步减仓
